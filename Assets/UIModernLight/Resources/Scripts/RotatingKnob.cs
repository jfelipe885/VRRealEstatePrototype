...
namespace UnityEngine.UI
{
	...
	{                           
		...
		protected override void Awake()
		{
			...
			if (mKnobArea == null) {
				throw new System.Exception("Error "+gameObject.name+": knob area missing.");
			} 
		...
		{  
			...
			RectTransform rectKnob = mKnobArea.rectTransform;
