...
public class TooltipManager : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
   ...
   // flag set after tooltip has been displayed, to avoid showing it once more
	...
	{                          
		...
		// If the left mouse button is pressed, the tooltip should be removed removed, such that it doesn't bother the user.
		// But IPointerDownHandler.OnPointerDown is not always called, so we check the left mouse button directly.
